    ...
    <div className="space-y-5">
      ...
      <section className="card sm:p-7">
        ...
        <div className="mt-6 border-t border-white/8 pt-5">
           {!data.comeceAquiCompleted ? <Button className="w-full" onClick={complete}>Concluir e começar Prompt Base<ArrowRight size={16} /></Button> : <Link href="/central/prompt-base" className="button button-primary w-full">Começar meu Prompt Base<ArrowRight size={16} /></Link>}
        </div>
      </section>
    </div>
  </>;
