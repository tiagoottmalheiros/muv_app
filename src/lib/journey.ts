...
export const journey = [
  ...
  { key: "step_1_diagnosis", title: "Tarefa 1 — Plano de Correção do Gargalo", short: "Plano de Correção", href: "/central/passo-1-diagnostico", weight: 15, deliverable: "Plano de ação para o gargalo" },
  { key: "step_2_buyer_map", title: "Tarefa 2 — Comprador Real", short: "Comprador Real", href: "/central/passo-2-comprador-real", weight: 15, deliverable: "Mapa Comprador vs. Curioso" },
  { key: "step_3_filter_message", title: "Tarefa 3 — Anúncio-Filtro", short: "Anúncio-Filtro", href: "/central/passo-3-mensagem-filtro", weight: 15, deliverable: "Primeiro Anúncio-Filtro" },
  { key: "step_4_triage_script", title: "Tarefa 4 — Triagem Lite", short: "Triagem Lite", href: "/central/passo-4-triagem", weight: 15, deliverable: "Script de Triagem Lite" },
