...
export const lessons: Record<OutputKey, Lesson> = {
  step_1_diagnosis: {
    key: "step_1_diagnosis", eyebrow: "Tarefa 1 de 4", title: "Tarefa 1 — Plano de Correção do Gargalo", objective: "Transformar sua base e seu Raio-X em um diagnóstico claro e um plano de ação para o principal gargalo.", central: "Mais lead não resolve lead ruim.", deliverable: "Tarefa 1 — Plano de Correção do Gargalo", nextHref: "/central/passo-2-comprador-real", nextLabel: "Avançar para Comprador Real",
  ...
  step_2_buyer_map: {
    key: "step_2_buyer_map", eyebrow: "Tarefa 2 de 4", title: "Comprador Real: Quem Deve Avançar e Quem Deve Ser Filtrado?", objective: "Definir critérios reais para transformar contato em oportunidade.", central: "Interesse não é oportunidade.", deliverable: "Mapa Comprador vs. Curioso", nextHref: "/central/passo-3-mensagem-filtro", nextLabel: "Avançar para Anúncio-Filtro",
  ...
  step_4_triage_script: {
    key: "step_4_triage_script", eyebrow: "Tarefa 4 de 4", title: "Triagem Lite: Como Parar de Tratar Curioso Como Oportunidade", objective: "Criar uma triagem humana antes de reunião, proposta ou atendimento comercial.", central: "Pergunte antes de explicar.", deliverable: "Script de Triagem Lite", nextHref: "/central/kit-final", nextLabel: "Assistir à aula final",
